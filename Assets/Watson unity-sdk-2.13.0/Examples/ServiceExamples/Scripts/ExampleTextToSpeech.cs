...
public class ExampleTextToSpeech : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {
            case 1:
                _testString = "<speak version=\"1.0\"><prosody pitch=\"150Hz\"><express-as type=\"GoodNews\">Hey I am Friday, nice to meet you.</prosody></speak>";  // When the corresponding command is spoken, the assistant will respond with this phrase
                Runnable.Run(Examples()); // Execute the TTS engine.
                SpeakState = 0;
                break;
            case 2:
                _testString = "<speak version=\"1.0\"><prosody pitch=\"170Hz\"><express-as type=\"GoodNews\"> I am very happy today </express-as></prosody></speak>";
                Runnable.Run(Examples());
                SpeakState = 0;
                break;
            case 3:
                _testString = "<speak version=\"1.0\"><prosody pitch=\\\"170Hz\\\"><express-as type=\"GoodNews\">Yes! I would love to</express-as></prosody></speak>";
                Runnable.Run(Examples());
                SpeakState = 0;
                break;
    ...
    public static IEnumerator I1_Hello()  // Coroutines which sets the state machine. Each one cooresponds to the case statement above.
    {
        Debug.Log("Hello");
        SpeakState = 1;
    ...
    public static IEnumerator I2_Howareyou()
    {
        Debug.Log("are you");
        SpeakState = 2;
        Debug.Log("SpeakState" + SpeakState);
    ...
    public static IEnumerator I3_chat()
    {
        Debug.Log("chat");
        SpeakState = 3;
        Debug.Log("SpeakState" + SpeakState);
